...
namespace Tinybit {
    ...
    function stop_the_car(): void { 
        ...
        buf[1] = 0; buf[2] = 0; buf[3] = 0; buf[4] = 0;         //stop
        pins.i2cWriteBuffer(PWM_ADD, buf);
    ...
    //% blockId=long_step_forward block="long_step_forward"
    //% weight=99
    //% blockGap=10
    //% color="#006400"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    export function long_step_forward(): void {
         
        move_step(); 
    }  

    /*
    //% blockId=Tinybit_Steps block="Steps|n_steps %n_steps"
    //% weight=99
    //% blockGap=10
    //% color="#006400"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    export function Steps(n_steps: number): void {
