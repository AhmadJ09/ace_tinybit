...
namespace Tinybit {
    ...
    function move_step(): void {
        ...
        buf[1] = 50; buf[2] = 0; buf[3] = 50; buf[4] = 0;    //run    
        pins.i2cWriteBuffer(PWM_ADD, buf);

        buf[1] = 25; buf[2] = 0; buf[3] = 25; buf[4] = 0;    //run    
        pins.i2cWriteBuffer(PWM_ADD, buf);

        buf[1] = 0; buf[2] = 0; buf[3] = 0; buf[4] = 0;    //run    
        pins.i2cWriteBuffer(PWM_ADD, buf);
    ...
    /*function move_step(): void {
        ...
        setTimeout(function callback() { buf[1] = 0; buf[2] = 0; buf[3] = 0; buf[4] = 0;         //stop
        pins.i2cWriteBuffer(PWM_ADD, buf);
    ...
    //% blockId=Tinybit_Step_Program block="Step"
    //% weight=99
    //% blockGap=10
    //% color="#006400"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    export function Tinybit_Step_Program(): void {
         
        move_step(); 
    }  

    //% blockId=Tinybit_Steps_Program block="Steps|n_steps %n_steps"
    //% weight=99
    //% blockGap=10
    //% color="#006400"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    export function Tinybit_Steps_Program(n_steps: number): void {
